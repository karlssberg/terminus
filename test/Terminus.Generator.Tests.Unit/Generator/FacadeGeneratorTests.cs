...
public class FacadeGeneratorTests : SourceGeneratorTestBase<FacadeGenerator>
{
    ...
    [Fact]
    public async Task Given_derived_FacadeOf_attribute_Should_generate_facade_correctly()
    {
        const string source =
            """
            using System;
            ...
            namespace Demo
            {
                // Custom derived FacadeOf attribute
                public class CustomFacadeAttribute : FacadeOfAttribute
                {
                    public CustomFacadeAttribute(Type facadeMethodAttribute) 
                        : base(facadeMethodAttribute)
                    {
                    }
                }

                [CustomFacade(typeof(HandlerAttribute))]
                public partial interface IFacade;
                ...
                public static class TestHandlers
                {
                    ...
                    [Handler]
                    public static string QueryData(int id)
                    {
                        return $"Data for {id}";
                    }
                }
        ...
        const string expectedMainSource =
            ...
            namespace Demo
            {
                ...
                public partial interface IFacade
                {
                    /// <summary>
                    /// Delegates to:<br/>
                    /// <see cref="Demo.TestHandlers.ProcessCommand(string)"/>
                    /// </summary>
                    void ProcessCommand(string command);
                    /// <summary>
                    /// Delegates to:<br/>
                    /// <see cref="Demo.TestHandlers.QueryData(int)"/>
                    /// </summary>
                    string QueryData(int id);
                }
                ...
                public sealed class IFacade_Generated : global::Demo.IFacade
                {
                    ...
                    void global::Demo.IFacade.ProcessCommand(string command)
                    {
                        global::Demo.TestHandlers.ProcessCommand(command);
                    }

                    string global::Demo.IFacade.QueryData(int id)
                    {
                        return global::Demo.TestHandlers.QueryData(id);
                    }
                }
            }
            """;
    ...
    [Fact]
    public async Task Given_derived_FacadeOf_attribute_with_properties_Should_generate_facade_correctly()
    {
        const string source =
            """
            using System;
            ...
            namespace Demo
            {
                // Custom derived FacadeOf attribute with custom properties
                public class CustomFacadeAttribute : FacadeOfAttribute
                {
                    public CustomFacadeAttribute(Type facadeMethodAttribute) 
                        : base(facadeMethodAttribute)
