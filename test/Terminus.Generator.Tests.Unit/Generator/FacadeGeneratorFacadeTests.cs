        ...
        const string source =
            ...
            namespace Demo
            {
                ...
                public class TestFacadeMethods
                {
                    ...
                    [FacadeMethod]
                    public string Helo(string world)
                    {
                         return world;
                    }
                }
          ...
          $$"""
            ...
            namespace Demo
            {
                ...
                internal sealed class IFacade_Generated : global::Demo.IFacade, global::Terminus.IDisposableScope, global::Terminus.IAsyncDisposableScope
                {
                    ...
                    private readonly global::System.Lazy<global::Terminus.Scope> _syncScope;
                    private readonly global::System.Lazy<global::Terminus.AsyncScope> _asyncScope;
                    ...
                    async void global::Demo.IFacade.Hello()
                    {
                        _syncScope.Value.ServiceProvider.GetRequiredService<global::Demo.TestFacadeMethods>().Hello();
                    }
                    
                    async string global::Demo.IFacade.Hello(string world)
                    {
