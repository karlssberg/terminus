...
public static class ServiceCollectionExtensions
{
    ...
    /// </code>
    /// </example>
    public static IServiceCollection AddTerminusFacades(
    ...
    /// </code>
    /// </example>
    public static IServiceCollection AddTerminusFacade<TInterface>(
        this IServiceCollection services)
    ...
    /// </code>
    /// </example>
    public static IServiceCollection AddTerminusFacade(
        this IServiceCollection services,
        Type interfaceType)
    {
        var callingAssembly = Assembly.GetCallingAssembly();
