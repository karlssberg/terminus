...
using Terminus.Example.StranglerFig;
...
var facade = serviceProvider.GetRequiredService<Terminus.Example.StranglerFig.IMyStranglerPatternFacade>();
...
Console.WriteLine((string?)facade.GetLegacyData(123));
...
namespace Terminus.Example.StranglerFig
{
    /***********************************************************/
