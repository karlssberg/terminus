...
namespace Terminus
{
    ...
    {
        private static IServiceCollection AddEntryPointsFor_Terminus_Generator_Examples_HelloWorld_IMyListener(this IServiceCollection services, Action<EntryPointOptions>? configure = null)
        {
            services.AddKeyedSingleton<Terminus.EntryPointOptions>(typeof(Terminus.Generator.Examples.HelloWorld.IMyListener), (provider, _) =>
            {
