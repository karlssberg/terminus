...
namespace Terminus
{
    public static partial class ServiceCollectionExtensions__Generated
    {
            ...
            where T : EntryPointAttribute
        {
            switch (typeof(T).FullName)
            {
                case "Terminus.Generator.Examples.HelloWorld.IMyListener":
                    return services.AddEntryPointFacadeFor_Terminus_Generator_Examples_HelloWorld_IMyListener(configure);
            };
        ...
        {
            services.AddEntryPointFacadeFor_Terminus_Generator_Examples_HelloWorld_IMyListener();
            return services;
        }
    }
}